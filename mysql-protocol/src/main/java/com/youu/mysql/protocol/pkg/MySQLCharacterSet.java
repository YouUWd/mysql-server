...
package com.youu.mysql.protocol.pkg;
...
public enum MySQLCharacterSet {
    ...
    private static final AttributeKey<MySQLCharacterSet> SERVER_CHARSET_KEY = AttributeKey.newInstance(
        MySQLCharacterSet.class.getName() + "-server");
    private static final AttributeKey<MySQLCharacterSet> CLIENT_CHARSET_KEY = AttributeKey.newInstance(
        MySQLCharacterSet.class.getName() + "-client");
